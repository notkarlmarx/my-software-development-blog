...
Laten we met het laatste punt beginnen. Het is de verantwoordelijkheid van `GetClaimsForUser()` de claim ergens vandaan te halen. Voor de inhoud van een claim is hij dat niet. laat staan voor alle. Deze kan dus geabstraheerd worden naar een aparte method. 
